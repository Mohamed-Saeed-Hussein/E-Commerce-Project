...
<section class="bg-gray-50 dark:bg-gray-900">
  <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
      ...
      <div class="w-full p-6 bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md dark:bg-gray-800 dark:border-gray-700 sm:p-8">
          ...
          <p class="text-sm text-gray-600 dark:text-gray-400 mb-6">Enter your email and create a new password for your account.</p>
          ...
          <form class="mt-4 space-y-4 lg:mt-5 md:space-y-5" method="POST" action="{{ url('/recover/reset') }}">
              @csrf
              <input type="hidden" name="email" value="{{ $email }}">
              <div>
                  <label for="email_display" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Email</label>
                  <input type="email" id="email_display" value="{{ $email }}" class="bg-gray-100 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:text-gray-300" readonly>
              </div>
              <div>
