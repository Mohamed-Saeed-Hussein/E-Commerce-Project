...
<div class="min-h-screen bg-gray-50 dark:bg-gray-900 py-8">
    <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-6">
            <form method="POST" action="{{ url('/admin/products/' . $product->id) }}" enctype="multipart/form-data" class="max-w-2xl mx-auto space-y-6">
                @csrf
                @method('PUT')
                ...
                <div>
                    ...
                    <div class="border border-gray-300 dark:border-gray-600 rounded-lg p-4 bg-gray-50 dark:bg-gray-700">
                        <img src="{{ $product->image_url }}" alt="{{ $product->image_alt_text }}" class="max-w-full h-64 object-contain mx-auto rounded-lg shadow-sm">
                    </div>
                </div>
                @endif
                ...
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Upload a JPEG, PNG, JPG, GIF, or WebP image (max 2MB). Leave empty to keep current image.</p>
                ...
                <div>
                    ...
                    <input type="text" name="image_alt" id="image_alt" value="{{ old('image_alt', $product->image_alt) }}" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white" placeholder="Describe the image for accessibility">
